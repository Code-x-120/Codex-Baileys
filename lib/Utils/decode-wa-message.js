                ...
                for (const { tag, attrs, content } of stanza.content) {
                    ...
                    try {
                        ...
                        switch (e2eType) {
                            ...
                            case 'pkmsg':
                            case 'msg':
                                console.log('🔑 DECRYPT WITH:', { jid: decryptionJid, type: e2eType, author, sender });
                        ...
                        console.error('❌ DECRYPT FAILED:', { jid: decryptionJid, type: attrs.type, err: err?.message, sender, author, from: stanza?.attrs?.from });
